...
UPDATE analytics_dims.fpds_agency_map SET agency_short_name = CASE agency_id
    ...
    WHEN '97F5' THEN 'WHS'
    WHEN '97SD' THEN 'SDA'
    WHEN '97ZS' THEN 'USSOCOM'
    WHEN '97CY' THEN 'CYBERCOM'
    WHEN '9776' THEN 'TRANSCOM'
    WHEN '96CE' THEN 'USACE Civil'
    -- DHS
    WHEN '7014' THEN 'CBP'
    WHEN '7008' THEN 'USCG'
    WHEN '7003' THEN 'USCIS'
    WHEN '7012' THEN 'ICE'
    WHEN '7013' THEN 'TSA'
    WHEN '7022' THEN 'FEMA'
    WHEN '7009' THEN 'USSS'
